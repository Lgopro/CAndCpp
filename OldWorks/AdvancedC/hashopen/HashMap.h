#ifndef __HASHMAPOPEN_H__
#define __HASHMAPOPEN_H__
...
typedef void (*DestroyFunction)(const void* _key);
...
/** 
 * @brief Find a value of an average collisions
 */
