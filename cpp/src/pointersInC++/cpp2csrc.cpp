...
public:
    ...
    PublicConvoy(const PublicConvoy& other) : PublicTransport(other), m_pt1(new Minibus(*(dynamic_cast<Minibus *>(other.m_pt1)))), m_pt2(new Taxi(*(dynamic_cast<Taxi *>(other.m_pt1)))), m_m(other.m_m), m_t(other.m_t)
    {
